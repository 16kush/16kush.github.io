const skillsData = [
    ...
    },
    {
        ...
        icon: "uil-globe",
        skills: [
            { name: "Python - Django, Flask, Fast API", percentage: 95 },
    ...
    },
	{
		...
		skills: [
            ...
            { name: "GANs", percentage: 85 },
            // { name: "TensorFlow & PyTorch", percentage: 85 },
            { name: "Model Deployment", percentage: 85 },
            { name: "Ensemble Methods", percentage: 80 },
		],
	},
	{
            ...
            <div class="skills__list grid">
                ${section.skills.map((skill) => 
                    `<div class="skills__data">
                        ...
                        <span class="skills__percentage skills__${skill.name.replace(/\s+/g, "-").toLowerCase()}" style="width: ${skill.percentage}%"></span>
                        </div>
                    </div>`).join("")}
            </div>`;
